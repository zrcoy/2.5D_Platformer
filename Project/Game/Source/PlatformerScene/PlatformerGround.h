...
class PlatformerGround : public GameObject
{
protected:
    MyPool<GameObject*>* m_pPoolThisObjectCameFrom;

public:
    PlatformerGround(Scene* pScene, std::string name, vec3 pos, vec3 rot, vec3 scale, Mesh* pMesh, Material* pMaterial);
    virtual ~PlatformerGround();
